                        ...
                        <form action="{{ route('artikel.update', $artikel->id) }}" method="POST"
                            ...
                            <div class="mb-4">
                                ...
                                <input type="text" name="judul"
                                    ...
                                    value="{{ $artikel->judul }}" placeholder="Barang" required>
                                @error('judul')
                            ...
                            <div class="mb-4">
                                ...
                                <textarea name="deskripsi" id="deskripsi" class="w-full p-2 border border-gray-300 rounded-md" rows="10">{{ old('deskripsi', $artikel->deskripsi ?? '') }}</textarea>
                            </div>
                            ...
                            <div class="mb-4">
                                ...
                                <select name="id_kategori"
                                    class="block appearance-none w-full bg-white border hover:border-gray-500 px-4 py-2 pr-8 rounded shadow leading-tight focus:outline-none focus:shadow-outline @error('id_kategori') border-red-500 @enderror">
