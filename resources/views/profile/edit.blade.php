                ...
                <div class="bg-white shadow-md rounded-lg overflow-hidden">
                    <div class="bg-gray-800 text-white px-6 py-3">
                        <div class="flex justify-between items-center">
                            <h4 class="font-semibold text-lg">{{ __('Edit profile') }}</h4>
                        ...
                        <form action="{{ route('profile.update', $profile->id) }}" method="POST"
                            ...
                            <div class="mb-4">
                                ...
                                <input type="text" name="tgl"
                                    ...
                                    value="{{ Auth::user()->name }}" disabled placeholder="tgl" required>
                                @error('tgl')
                                    <p class="text-red-500 text-xs italic">{{ $message }}</p>
                                @enderror
                            </div>
                            ...
                            <div class="mb-4">
                                <label class="  text-gray-700 text-sm font-bold mb-2">Jenis Kelamin</label>
