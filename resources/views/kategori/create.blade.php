                ...
                <div class="p-6">
                    <form action="{{ route('kategori.store') }}" method="POST" enctype="multipart/form-data">
                        ...
                        <div class="mb-4">
                            ...
                            <input type="text" class="w-full px-3 py-2 border rounded @error('nama_kategori') border-red-500 @enderror" name="nama_kategori" value="{{ old('nama_kategori') }}" placeholder="Nama">
                            @error('nama_kategori')
                        ...
                        <div class="mb-4">
                            ...
                            <textarea class="w-full px-3 py-2 border rounded @error('deskripsi') border-red-500 @enderror" name="deskripsi" rows="3" placeholder="Deskripsi">{{ old('deskripsi') }}</textarea>
                            @error('deskripsi')
                            <span class="text-red-500 text-sm mt-1">{{ $message }}</span>
                            @enderror
                        </div>
